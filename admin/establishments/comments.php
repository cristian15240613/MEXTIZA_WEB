         ...
         <ul class="nav nav-tabs">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="taquerias.php?IDU=<?php echo $sesion;?>">Tiendas</a>
              <a class="dropdown-item" href="products.php?IDU=<?php echo $sesion;?>">Productos</a>
              <a class="dropdown-item" href="comments.php?IDU=<?php echo $sesion;?>">Comentarios</a>
            </div>
          </li>
          <li class="nav-item">
               ...
               <tbody>
                  <!-- CON PHP GENERAR FILAS -->
                   <?php
                    ...
                    $query="SELECT ID_COMENTARIO,ID_SUCURSAL,ID_USUARIO,COMENTARIO,FECHA FROM COMENTARIOS";
                    $resultado=mysqli_query($conection,$query) or die(mysqli_error($conection));
                    
                   
                      while($consulta =mysqli_fetch_array($resultado)){ 
                   
                    $queryy="SELECT NOMBRE FROM SUCURSAL WHERE ID_SUCURSAL=".$consulta['ID_SUCURSAL'].";";
