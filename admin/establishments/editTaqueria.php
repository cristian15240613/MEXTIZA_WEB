...
function consultaPersona($id){
    ...
    global $conection;
    $query="SELECT ID_SUCURSAL,TELEFONO,NOMBRE,DIRECCION,DESCRIPCION,ID_USUARIO,ESTATUS_SUCURSAL,IMAGEN FROM SUCURSAL WHERE ID_SUCURSAL=".$id.";";
    $resultado=mysqli_query($conection,$query);
    $filas=mysqli_fetch_array($resultado) or die (mysqli_error());
    return [$filas['ID_SUCURSAL'],
            $filas['TELEFONO'],
            $filas['NOMBRE'],
            $filas['DIRECCION'],
            $filas['DESCRIPCION'],
       ...
       <form class="needs-validation" action="../../PHP/EditarTaqueriaAdmin.php" method="post" novalidate enctype="multipart/form-data">
          <div class="form-row justify-content-md-center">           
            ...
            <div class="col-md-4 mb-2">
              ...
              <input type="text" class="form-control" id="validationCustom01" value="<?php echo $consulta[2];?>" placeholder="Nombre de tu local" required name="nombre">
            ...
            <div class="col-md-2 mb-2">
             <label for="validationCustom04">Teléfono</label>
              <input type="text" class="form-control" id="validationCustom04" value="<?php echo $consulta[1];?>" placeholder="Lada - Telefono" name="telefono" required>
              <div class="invalid-feedback">
            ...
            <div class="col-md-6 mb-2">
              ...
              <input type="text" class="form-control" id="validationCustom02" value="<?php echo $consulta[3];?>"
          ...
          <div class="form-row">           
            <div class="col-md-6 mb-3" >
              ...
              <textarea class="form-control" placeholder="Incluye informacion importante como tus horarios, tus días de trabajo" name="descripcion" id="descripcion" rows="10" required> <?php echo $consulta[4];?></textarea>
              <div class="invalid-feedback">
            ...
            <div class="form-check">
             ...
             <div class="col-md-6 mb-2">         
                <img height="50%" src="data:image/jpg;base64,<?php echo base64_encode($consulta[7]);?>">
              </div>
